...
abstract class WrapperAdapter implements WrapperListAdapter, ItemMainLayout.OnItemSlideListenerProxy, View.OnClickListener,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            itemMainLayout.setParams(mMenu.getmItemHeight(), mMenu.getTotalBtnLength(MenuItem.DIRECTION_LEFT),
                    mMenu.getTotalBtnLength(MenuItem.DIRECTION_RIGHT), mMenu.ismWannaOver());
    ...
    protected void setSlideItemPosition(int position) {
        ...
        for (View v : itemMainLayout.getItemLeftBackGroundLayout().getmBtnViews()) {
            v.setClickable(true);
        }
        for (View v : itemMainLayout.getItemRightBackGroundLayout().getmBtnViews()) {
            v.setClickable(true);
        }
    }
