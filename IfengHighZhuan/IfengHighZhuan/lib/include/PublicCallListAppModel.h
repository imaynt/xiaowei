...
// 该应用的id（可以作为跟其他广告的区分）。 the id for this app declared by sdk
...
// 简短广告词。short introduction for this app
